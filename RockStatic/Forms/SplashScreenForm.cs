...
namespace RockStatic
{
    public partial class SplashScreenForm : Form
    {
        ...
        private void SplashScreenForm_Paint(object sender, PaintEventArgs e)
        {
            ...
            ControlPaint.DrawBorder(e.Graphics, e.ClipRectangle, Color.DarkGreen, 1, ButtonBorderStyle.Solid, Color.DarkGreen, 1, ButtonBorderStyle.Solid, Color.DarkGreen, 1, ButtonBorderStyle.Solid, Color.DarkGreen, 1, ButtonBorderStyle.Solid);
        }
